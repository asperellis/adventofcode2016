...
// i = 0;
//
// const repeater = function(input, recurse){
//   let sum = 0;
//
//   while(data.length > 0){
//     if (data[0] === "(") {
...
// };
//
// decryptedData2 = repeater(data, repeater);
...
final.forEach(function(arr){
  ...
  for(var i = 0; i < arr.length; i++){
    if(arr[i].length > 1) {
      ...
      sum += innerSum;
      console.log('arr is single', numbers);
    }
  }
  console.log(arr, sum);
});
...
console.log('Part 1: Decrypted Data Length: ', decryptedData.length);
console.log('Part 2: Decrypted Data Length: ', sum); //11125026826 is answer
// 1125026826
// 3033225360
