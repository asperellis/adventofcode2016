...
// checks string for aba charachter sequences outside of HYPERNET areas then checks within HYPERNET strings for the bab sequence of the same characters
const hasAba = function(arr) {
  let flag = false;
  let aba = [];
  //search for abas
  for(let j = 0; j < arr.length; j++){
