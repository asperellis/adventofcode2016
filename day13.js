// Day 13 solution
// Used an A* Algorithm from github - pasted because I'm doing all the work in the console.
...
console.log("Part 1 Answer: ", result.length);
console.log("Part 2 Answer: ", reachinFifty + 1); // add one to include start space
